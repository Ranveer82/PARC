...
def mf_simulator():
    ...
    modflow_model = global_var.model+"_h5_parallel.exe"
...
def mf_simulator2():
    ...
    modflow_nwt_path = f"{parent_path}/{global_var.filename}_MODFLOW/"+global_var.model+"_h5_parallel.exe"
    ...
    if process.returncode == 0:
        print("MODFLOW NWT execution successful.")
    else:
        print("MODFLOW NWT execution failed.")
    go_to_the_root()
